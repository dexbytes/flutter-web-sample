...
import 'package:flutter_gmail_responsive/src/models/user_model.dart';
...
final User medium = User(id: 3, name: 'Medium Daily', imageUrl: Colors.pink);
...
final User digitalocean4 = User(id: 12, name: 'Digital Ocean', imageUrl: Colors.pinkAccent);
